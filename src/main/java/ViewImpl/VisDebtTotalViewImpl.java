...
public class VisDebtTotalViewImpl implements VisDebtTotalView{

	final ControllerVisDebtTotalObserver observer;
	final JFrame frame = new JFrame();
	private static final String TITLE_FRAME = "Visualizzazione debito totale paziente";
	  
	public static final int SPACE = 5;
	public static final String TITLE = "Visualizzazione del debito totale di un paziente";
	...
	private final JTextField textDebtTotal = new JTextField("", 12); //written that will be removed when clicked
	...
	public VisDebtTotalViewImpl(ControllerVisDebtTotalObserver observer) {
        ...
        pWestInternal.add(textDebtTotal, cnst);
        textDebtTotal.setEditable(false);
        cnst.gridy++;
	...
	@Override
	public void updateView(String total) {
	    textDebtTotal.setText(total);
